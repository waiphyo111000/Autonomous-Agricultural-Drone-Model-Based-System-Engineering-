# This repo describe autonomous agricultural drone model based on MBSE. You can show screenshops that are describing the flow and structure of drone model. 
